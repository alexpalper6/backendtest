...
@CucumberOptions(plugin = {
        "json:target/GetOrderByIdIT.json",
        "html:target/GetOrderByIdIT.html",
        "junit:target/GetOrderByIdIT.xml"
}, features =
        {
                "src/test/resources/features/petstore/store/get/get_order_by_id.feature"
        },
        glue = "classpath:app.teralco.testing.backendtest.glue")

public class GetOrderByIdIT extends BaseGTest {
}
